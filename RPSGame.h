...
#define NOT_ABLE_TO_MOVE "ERROR MOVE: piece chosen is not able to move.\n"
#define DST_PIECE "ERROR MOVE: required location to move contains same player piece.\n"
#define MOVE_NOT_LEGAL "ERROR MOVE: one or more moves is illegal according to game rules.\n"
#define NO_JOKER "ERROR MOVE: the is no joker at required location.\n"
...
public:
    RPSGame(unique_ptr<PlayerAlgorithm>& algo_player1, unique_ptr<PlayerAlgorithm>& algo_player2) : m_current_player(PLAYER_1), m_game_over(false), m_num_moving_pieces_player1(0), m_num_moving_pieces_player2(0),
                ...
                m_algo_player1(std::move(algo_player1)), m_algo_player2(std::move(algo_player2)) {
